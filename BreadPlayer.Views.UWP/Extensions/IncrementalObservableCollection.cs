...
{
    /// <summary>
    /// This class represents an <see cref="ThreadSafeObservableCollection{IType}"/> whose items can be loaded incrementally.
    /// </summary>
    ...
    public class IncrementalLoadingObservableCollection<TSource, IType> : ThreadSafeObservableCollection<IType>,
         ...
         where TSource : IIncrementalSource<IType>
    {
        ...
        /// </param>
        /// <seealso cref="IIncrementalSource{TSource}"/>
        public IncrementalLoadingObservableCollection(int itemsPerPage = 20, Action onStartLoading = null, Action onEndLoading = null, Action<Exception> onError = null)
        ...
        /// </param>
        /// <seealso cref="IIncrementalSource{TSource}"/>
        public IncrementalLoadingObservableCollection(TSource source, int itemsPerPage = 20, Action onStartLoading = null, Action onEndLoading = null, Action<Exception> onError = null)
        {
            if (source == null)
            {

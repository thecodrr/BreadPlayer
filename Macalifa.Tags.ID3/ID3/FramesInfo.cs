...
namespace Macalifa.Tags.ID3.ID3v2Frames
{
    ...
    public static class FramesInfo
    {
        ...
        private static List<string> _ExcludedList;
        public static List<string> ExcludedList
        {
            get
            {
                if (_ExcludedList == null)
                {
        ...
        private static void InitExcludedList()
        {
            ExcludedList.Add("RGAD");
            ExcludedList.Add("NCON");
            ExcludedList.Add("CRM");
            ExcludedList.Add("AENC");
            ExcludedList.Add("PCNT");
            ExcludedList.Add("MLLT");
            ExcludedList.Add("MCDI");
            ExcludedList.Add("LINK");
            ExcludedList.Add("IPLS");
            ExcludedList.Add("GRID");
            ExcludedList.Add("GEOB");
            ExcludedList.Add("ETCO");
            ExcludedList.Add("EQUA");
            ExcludedList.Add("EQU2");
            ExcludedList.Add("ENCR");
            ExcludedList.Add("ASPI");
            ExcludedList.Add("COMR");
            ExcludedList.Add("SEEK");
            ExcludedList.Add("TRSO");
            ExcludedList.Add("TRSN");
            ExcludedList.Add("RVAD");
            ExcludedList.Add("TSOT");
            ExcludedList.Add("TSOP");
            ExcludedList.Add("TSOA");
            ExcludedList.Add("TSSE");
            ExcludedList.Add("TSST");
            ExcludedList.Add("TSRC");
            ExcludedList.Add("UFID");
            ExcludedList.Add("WCOM");
            ExcludedList.Add("RVA2");
            ExcludedList.Add("TSIZ");
            ExcludedList.Add("RBUF");
            ExcludedList.Add("PRIV");
            ExcludedList.Add("POSS");
            ExcludedList.Add("TOWN");
            ExcludedList.Add("TOFN");
            ExcludedList.Add("TOAL");
            ExcludedList.Add("TLEN");
            ExcludedList.Add("TPE4");
            ExcludedList.Add("TKEY");
            ExcludedList.Add("TIT1");
            ExcludedList.Add("TIPL");
            ExcludedList.Add("TFLT");
            ExcludedList.Add("TPRO");
            ExcludedList.Add("TPOS");
            ExcludedList.Add("TDTG");
            ExcludedList.Add("TDLY");
            ExcludedList.Add("SYTC");
            ExcludedList.Add("TOLY");
            ExcludedList.Add("TOPE");
            ExcludedList.Add("TORY");
            ExcludedList.Add("TMCL");
            ExcludedList.Add("WPUB");
            ExcludedList.Add("USLT");
            ExcludedList.Add("USER");
            ExcludedList.Add("TPE3");
            ExcludedList.Add("WPAY");
            ExcludedList.Add("WORS");
            ExcludedList.Add("WOAS");
            ExcludedList.Add("WOAR");
            ExcludedList.Add("WOAF");
            ExcludedList.Add("WCOP");
            ExcludedList.Add("TRDA");
            ExcludedList.Add("TLAN");
            ExcludedList.Add("TDRL");
            ExcludedList.Add("TENC");
            ExcludedList.Add("TDRC");
            ExcludedList.Add("TDOR");
            ExcludedList.Add("TCOP");
            ExcludedList.Add("TDAT");
            ExcludedList.Add("TDEN");
            ExcludedList.Add("SIGN");
            ExcludedList.Add("PRIV");
